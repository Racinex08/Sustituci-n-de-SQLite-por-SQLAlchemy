...
# Configuración inicial de Flask y SQLAlchemy
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mariadb://Racinex08:password@localhost/Sustitución de SQLite por SQLAlchemy.py'
...
if __name__ == "__main__":
    with app.app_context():  # Necesario para ejecutar el contexto de la app de Flask
        menu()
